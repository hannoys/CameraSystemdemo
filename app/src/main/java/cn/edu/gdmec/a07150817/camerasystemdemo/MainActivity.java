package cn.edu.gdmec.a07150817.camerasystemdemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case 1 :
                ...
                intent.setAction("android.media.STILL_IMAGE_CAMERA");
    ...
    private void takePhoto(){
        ...
        //以当前时间作为相片名字，其中yyyy表示年，mm表示月，dd表示日。hh表示时，mm表示分，ss表示秒
